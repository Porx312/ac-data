...
var _ACRemoteTelemetryParser = require('ac-remote-telemetry-client/lib/parsers/ACRemoteTelemetryParser');

var _ACRemoteTelemetryParser2 = _interopRequireDefault(_ACRemoteTelemetryParser);
...
var RTCarInfoParser = function (_ACRemoteTelemetryPar) {
  _inherits(RTCarInfoParser, _ACRemoteTelemetryPar);

  function RTCarInfoParser() {
    _classCallCheck(this, RTCarInfoParser);

    var _this = _possibleConstructorReturn(this, (RTCarInfoParser.__proto__ || Object.getPrototypeOf(RTCarInfoParser)).call(this));

    _this.endianess('little').string('identifier', { encoding: 'utf-16le', length: 4, stripNull: true }) // Offset: 0
  ...
  return RTCarInfoParser;
}(_ACRemoteTelemetryParser2.default);

exports.default = RTCarInfoParser;